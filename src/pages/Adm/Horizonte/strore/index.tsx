...
const HorizonteStore = () => {
  ...
  async function handleChange(e: IHorizonteForm) {
    setFormData((state: IHorizonteForm) => ({ ...state, ...e }))
  }
  ...
  async function handleCheck(e: string) {
    ...
    setFormData((state: IHorizonteForm) => ({ ...state, topic }))
  }
